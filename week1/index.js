...
let numberArr2 = numberArr1; //宣告一個「物件型別(陣列)」的變數，名稱為「numberArr2」，賦值依據「numberArr1」傳址
numberArr2.push(20); //針對變數「numberArr2」，新增「20」至陣列的最後位置為「[5, 10, 15, 20]」，同時傳址給變數「numberArr1」
numberArr2 = [25, 30, 35]; //針對變數「numberArr2」，重新賦值為「[25, 30, 35]」，同時傳址給變數「numberArr1」
console.log(numberArr1, numberArr2); //呈現變數「numberArr1」與「numberArr2」的值，皆為「[25, 30, 35]」
